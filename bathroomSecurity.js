...
const newGenerateCoordinate = (keypad, coordinate, direction) => {
  let x = coordinate[0];
  let y = coordinate[1];

  if (direction === 'U') {
    if (keypad[y + 1] && keypad[y + 1][x] && keypad[y + 1][x] !== '') {
      coordinate[1] += 1;
    }
  } else if (direction === 'D') {
    if (keypad[y - 1] && keypad[y - 1][x] && keypad[y - 1][x] !== '') {
    ...
    if (keypad[y] && keypad[y][x + 1] && keypad[y][x + 1] !== '') {
      coordinate[0] += 1;
    }
  } else if (direction === 'L') {
    if (keypad[y] && keypad[y][x - 1] && keypad[y][x - 1] !== '') {
...
const newBathroomCode = (input) => {
  const keypad = [['', '', 'D', '', ''], ['', 'A', 'B', 'C', ''], ['5', '6', '7', '8', '9'], ['', '2', '3', '4', ''], ['', '', '1', '', '']];
  const rawCode = input.split('\n');

  let finalCode = '';
  let currentCoordinate = [2, 0];

  rawCode.forEach(line => {
    line.split('').forEach(direction => {
      currentCoordinate = newGenerateCoordinate(keypad, currentCoordinate, direction)
    })
    finalCode += generateKey(keypad, currentCoordinate);
  });
  return finalCode;
...
console.log(newBathroomCode(''))
